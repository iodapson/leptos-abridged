...
You generally don't need global state management except for special cases like;

- Theming
- Saving user settings
- Or sharing data between components in different parts of your UI

1. The three best approaches to global state are;
...
2. For details about the first two options, check (Option1)[https://leptos-rs.github.io/leptos/15_global_state.html#option-1-url-as-global-state] and (Option2)[https://leptos-rs.github.io/leptos/15_global_state.html#option-1-url-as-global-state]

3. Option three example code of creating a Global state struct and slices (`create_slice`) in which each signal only updates when the particular piece of a larger state struct it accessess updates.
